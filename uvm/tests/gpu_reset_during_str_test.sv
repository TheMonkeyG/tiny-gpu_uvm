class gpu_reset_during_str_test extends gpu_base_test;
    ...
    virtual task run_phase(uvm_phase phase);
        ...
        `uvm_info("TEST", "=== Launching 32-STR kernel (arbiter program) ===", UVM_LOW)
    ...
    task launch_matadd(int unsigned threads);
        gpu_kernel_seq seq2 = gpu_kernel_seq::type_id::create("seq2");
        seq2.num_threads = threads;
        seq2.data_base = 0;
        gpu_program_lib::matadd(seq2.prog, seq2.data_bytes);
